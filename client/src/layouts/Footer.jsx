        ...
        <>
            <div className="grid grid-cols-6 bg-black p-[25px] items-center max-lg:grid-cols-3 max-lg:pb-[100px] max-lg:gap-4 max-md:grid-cols-2">
                <div className="px-5 max-lg:p-0">
                    <img className="w-[170px]" src="https://res.cloudinary.com/dz93cdipw/image/upload/v1713860650/Book-Store/logo/wjmbwk6ugkhy4qvajszm.png" alt="Logo" />
                ...
                <div>
                    ...
                    <span className="block text-[#999999]">Review sách</span>
            ...
            <div className="bg-black text-center mt-4">
                ...
                <span className="text-[#999999] block">© 2025 Nguyen Phu Huy. All rights reserved.</span>
            </div>
        </>
    );
};
